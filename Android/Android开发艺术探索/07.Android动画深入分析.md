...
\<set>标签表示动画集合，对应AnimationSet类，可以包含若干个动画，并且内部也可以嵌套其他动画集合，还有两个属性：
...
```java
mButton.setBackgroundResource(R.drawable.drawable_custom_view);
...
<layoutAnimation xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    android:animation="@anim/anim_custom_view"/>
```

android:delay：子元素的动画延迟。
