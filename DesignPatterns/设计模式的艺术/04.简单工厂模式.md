...
![简单工厂模式结构图](E:\Github仓库\Notes\DesignPatterns\设计模式的艺术\assets\简单工厂模式结构图.PNG)
...
![图表库结构图](E:\Github仓库\Notes\DesignPatterns\设计模式的艺术\assets\图表库结构图.PNG)
...
![简化的简单工厂模式](E:\Github仓库\Notes\DesignPatterns\设计模式的艺术\assets\简化的简单工厂模式.PNG)
