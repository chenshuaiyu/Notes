...
![原型模式结构图](E:\Github仓库\Notes\DesignPatterns\设计模式的艺术\assets\原型模式结构图.PNG)
...
![浅克隆示意图](E:\Github仓库\Notes\DesignPatterns\设计模式的艺术\assets\浅克隆示意图.PNG)
...
![深克隆示意图](E:\Github仓库\Notes\DesignPatterns\设计模式的艺术\assets\深克隆示意图.PNG)
...
![带原型管理器的结构图](E:\Github仓库\Notes\DesignPatterns\设计模式的艺术\assets\带原型管理器的结构图.PNG)
