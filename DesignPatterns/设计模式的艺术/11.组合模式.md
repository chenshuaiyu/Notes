...
![杀毒软件框架设计结构图](E:\Github仓库\Notes\DesignPatterns\设计模式的艺术\assets\杀毒软件框架设计结构图.PNG)
...
#### ![透明组合模式结构图](E:\Github仓库\Notes\DesignPatterns\设计模式的艺术\assets\透明组合模式结构图.PNG)
...
![安全组合模式结构图](E:\Github仓库\Notes\DesignPatterns\设计模式的艺术\assets\安全组合模式结构图.PNG)
...
![AWT组合模式结构示意图](E:\Github仓库\Notes\DesignPatterns\设计模式的艺术\assets\AWT组合模式结构示意图.PNG)
